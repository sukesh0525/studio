    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Paste your resume text below to check for common issues and verify its authenticity.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea rows={15} placeholder="Paste the full text of your resume here..." {...field} />
                    </FormControl>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>The AI's feedback on your resume will appear here.</CardDescription>
        </CardHeader>
        <CardContent>
          {isPending && (
